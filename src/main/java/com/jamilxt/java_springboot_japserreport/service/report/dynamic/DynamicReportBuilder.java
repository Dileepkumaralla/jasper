...
public class DynamicReportBuilder {
  ...
  public void addDynamicColumns(List<Integer> currencyFieldIndexes) throws JRException {
    ...
    JRDesignBand summaryBand = new JRDesignBand(); // Summary band for total
    ...
    for (int i = 0, j = 0; i < numColumns; i++) {
      ...
      if (currencyFieldIndexes.contains(i)) {
        ...
        JRDesignField summaryField = new JRDesignField();
        ...
        JRDesignTextField summaryTextField = new JRDesignTextField();
        ...
        JRLineBox summaryBox = summaryTextField.getLineBox();
        ...
        JRDesignExpression summaryExpression = new JRDesignExpression();
